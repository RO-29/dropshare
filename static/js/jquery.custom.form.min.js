/*ajaxSubmit*/
(function(){(function(e){var t,n;e.errors={attribute:"validate",activationClass:"validation-active",format:"<div class='validation-block'><div class='validation-message'></div></div>",messageClass:"validation-message"};n=function(t,n){var r;if(!t.hasClass(e.errors.activationClass)){t.addClass(e.errors.activationClass);r=t.find("."+e.errors.messageClass);if(r.size()===0)t.append(e.errors.format);r=t.find("."+e.errors.messageClass);if(r.size()>0){return r.html(n)}else{throw new Error("configuration error: $.errors.format must have elment with class "+e.errors.messageClass)}}};t=function(t,r,i){var s;s=t.find("["+e.errors.attribute+"~='"+r+"']");if(s.size()===0){s=e("<div "+e.errors.attribute+"='"+r+"'>"+('Unassigned error: Add validate="'+r+'" attribute somewhere in a form.</div>'));t.prepend(s)}return n(s,i)};e.fn.applyErrors=function(t){e(this).clearErrors();return e(this).addErrors(t)};e.fn.addErrors=function(n){var r,i;r=e(this);if(e.type(n)==="object"){i=n;n=[];e.each(i,function(t,r){if(r&&!(e.isArray(r)&&r.length===0)){return n.push([t,r])}})}return e(n).each(function(n,i){var s,o;s=i[0];o=i[1];if(e.isArray(o))o=o[0];return t(r,s,o)})};return e.fn.clearErrors=function(){var t;t=e(this).find("["+e.errors.attribute+"]");t.find("."+e.errors.messageClass).html("");return t.removeClass(e.errors.activationClass)}})(jQuery)}).call(this);(function(){(function(e){var t,n;e.fn.ajaxSubmit=function(r){var i,s,o,u,a,f;if(r==null)r={};i=e(this);i.clearErrors();if(typeof r==="function")r.success=r;if(r.redirect&&!r.success){r.success=function(){return window.location=r.redirect}}s=r.success;u=r.error;a=i.attr("method")||"get";f=i.attr("action");o=i.serialize();if(!jQuery.isEmptyObject(r.data)){o=o+"&"+e.param(r.data)}return e.ajax({type:r.type||a,url:r.url||f,data:o,success:function(e){return n(i,e,s,u)},error:function(e,n,r){return t(i)}})};n=function(t,n,r,i){e("#divTicket").dialog("destroy");e("#divTicket").remove();CloseTicketPopUp()};t=function(e){};return e.fn.ajaxForm=function(t){if(t==null)t={};return e(this).bind("submit",function(n){n.preventDefault();return e(this).ajaxSubmit(t)})}})(jQuery)}).call(this);

/*Deferred*/
(function(e){var t="done fail isResolved isRejected promise then always pipe".split(" "),n=[].slice;if(typeof e!=="function"){return false}else{jQuery.each(t,function(){if(typeof jQuery[this]!=="undefined"){return false}})}if(typeof jQuery.type==="undefined"){var r={};jQuery.each("Boolean Number String Function Array Date RegExp Object".split(" "),function(e,t){r["[object "+t+"]"]=t.toLowerCase()});jQuery.extend({type:function(e){return e==null?String(e):r[toString.call(e)]||"object"}})}jQuery.extend({_Deferred:function(){var e=[],t,n,r,i={done:function(){if(!r){var n=arguments,s,o,u,a,f;if(t){f=t;t=0}for(s=0,o=n.length;s<o;s++){u=n[s];a=jQuery.type(u);if(a==="array"){i.done.apply(i,u)}else if(a==="function"){e.push(u)}}if(f){i.resolveWith(f[0],f[1])}}return this},resolveWith:function(i,s){if(!r&&!t&&!n){s=s||[];n=1;try{while(e[0]){e.shift().apply(i,s)}}finally{t=[i,s];n=0}}return this},resolve:function(){i.resolveWith(this,arguments);return this},isResolved:function(){return!!(n||t)},cancel:function(){r=1;e=[];return this}};return i},Deferred:function(e){var n=jQuery._Deferred(),r=jQuery._Deferred(),i;jQuery.extend(n,{then:function(e,t){n.done(e).fail(t);return this},always:function(){return n.done.apply(n,arguments).fail.apply(this,arguments)},fail:r.done,rejectWith:r.resolveWith,reject:r.resolve,isRejected:r.isResolved,pipe:function(e,t){return jQuery.Deferred(function(r){jQuery.each({done:[e,"resolve"],fail:[t,"reject"]},function(e,t){var i=t[0],s=t[1],o;if(jQuery.isFunction(i)){n[e](function(){o=i.apply(this,arguments);if(o&&jQuery.isFunction(o.promise)){o.promise().then(r.resolve,r.reject)}else{r[s+"With"](this===n?r:this,[o])}})}else{n[e](r[s])}})}).promise()},promise:function(e){if(e==null){if(i){return i}i=e={}}var r=t.length;while(r--){e[t[r]]=n[t[r]]}return e}});n.done(r.cancel).fail(n.cancel);delete n.cancel;if(e){e.call(n,n)}return n},when:function(e){function u(e){return function(r){t[e]=arguments.length>1?n.call(arguments,0):r;if(!--s){o.resolveWith(o,n.call(t,0))}}}var t=arguments,r=0,i=t.length,s=i,o=i<=1&&e&&jQuery.isFunction(e.promise)?e:jQuery.Deferred();if(i>1){for(;r<i;r++){if(t[r]&&jQuery.isFunction(t[r].promise)){t[r].promise().then(u(r),o.reject)}else{--s}}if(!s){o.resolveWith(o,t)}}else if(o!==e){o.resolveWith(o,i?[e]:[])}return o.promise()}})})(jQuery);
